...
if(PDF) pdf("pdf/emulate_MEs_hydro_new32.pdf")

rm_avg <- T

des0 = read.table("hydro.design_c")
...
save(modRuns_hydro, file = "modRuns_hydro_new32.rda")
...
save(avg_mean_hydro, file = "rda/avg_mean_hydro_new32.rda")
save(mainEffs_real, file = "rda/mainEffs_real_new32.rda")
save(mainEffs_true_hydro, file = "rda/mainEffs_true_hydro_new32.rda")
