...
PDF <- T
if(PDF) pdf("pdf/new32_hydro_complete.pdf")

rm_avg <- T

des1 = read.table("hydro.design")
des1_pred = read.table("hydro.design_c")
...
new32_preds = eta1pred+eta2pred+eta3pred+eta4pred+eta5pred+
  eta6pred+eta7pred+eta8pred+eta9pred+eta10pred+eta11pred+mean0mat
...
new32_preds_b = bss1pred+bss2pred+bss3pred+bss4pred+bss5pred+
  bss6pred+bss7pred+bss8pred+bss9pred+bss10pred+bss11pred+mean0mat
...
new32_preds_bm <- bss1pred_meo+bss2pred_meo+bss3pred_meo+bss4pred_meo+bss5pred_meo+
  bss6pred_meo+bss7pred_meo+bss8pred_meo+bss9pred_meo+bss10pred_meo+bss11pred_meo+mean0mat

# pdf("new32_compare.pdf")
par(mfrow=c(1,1))
...
save(modRuns, file = "rda/modRuns.rda")
save(modRuns_pred, file = "rda/modRuns_pred.rda")
save(new32_preds, file = "rda/new32_preds.rda")
save(new32_preds_b, file = "rda/new32_preds_b.rda")
save(new32_preds_bm, file = "rda/new32_preds_bm.rda")
save.image("/projects/precipit/hydro/new32_hydro.rda")
